...
var KTAppInboxCompose = function () {
    ...
    const initTagify = (el) => {
        ...
        const usersList = [
            { value: 1, name: 'Writer', avatar: 'avatars/300-6.jpg', email: 'e.smith@kpmg.com.au' },
            { value: 2, name: 'Customer', avatar: 'avatars/300-1.jpg', email: 'max@kt.com' },
            { value: 3, name: 'Sub Admin', avatar: 'avatars/300-5.jpg', email: 'sean@dellito.com' }
        ];
