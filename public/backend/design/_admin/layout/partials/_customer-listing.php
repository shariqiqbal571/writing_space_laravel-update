	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Customer Management Table</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
						...
						<tbody class="fw-semibold text-gray-600">
							<tr>
								...
								<td><a href="customer-details.php">0931821</a></td>
								<td>
									smith@kpmg.com
								</td>
								<td><a href="customer-first-subscriber.php" class="text-success">(Teir-2) First Subscriber</a></td>
								<td data-filter="mastercard">
									<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3872
								</td>
								<td>13/12/2020, 8:43 pm</td>
								<td class=""><span class="badge badge-light-success fw-bold me-auto px-4 py-3">White List/ Enable</span></td>
							</tr>
							<tr>
								<td>
									<div class="form-check form-check-sm form-check-custom form-check-solid">
								...
								<td><a href="customer-details.php">0942921</a></td>
								<td>
									will@kpmg.com
								</td>
								<td><a href="customer-multiple-subscriber.php" class="text-warning">(Teir-3) Multiple Subscriber</a></td>
								<td data-filter="mastercard">
									<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3872
								</td>
								<td>14 Dec 2020, 8:43 pm</td>
								<td class=""><span class="badge badge-light-danger fw-bold me-auto px-4 py-3">Black List/Disable</span></td>
							</tr>
							<tr>
								<td>
									<div class="form-check form-check-sm form-check-custom form-check-solid">
								...
								<td><a href="customer-details.php">0382722</a></td>
								<td>
									tom@kpmg.com
								</td>
								<td><a href="customer-posted-order.php" class="text-primary">(Teir-1) Posted Custom Order</a></td>
								<td data-filter="mastercard">
									<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3872
								</td>
								<td>12/12/2019, 8:43 pm</td>
								<td class=""><span class="badge badge-light-success fw-bold me-auto px-4 py-3">White List/ Enable</span></td>
							</tr>
							<tr>
								<td>
								...
								<td><a href="customer-details.php">0972641</a></td>
								<td>
									harry@kpmg.com
								</td>
								<td><a href="customer-brand-ambassador.php" class="text-info">(Teir-4) Brand Ambassador</a></td>
								<td data-filter="mastercard">
									<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3872
								</td>
								<td>20/082020, 8:43 pm</td>
								<td class=""><span class="badge badge-light-danger fw-bold me-auto px-4 py-3">Black List/Disable</span></td>
							</tr>
						</tbody>
					</table>
