                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="view-user.php" class="text-gray-800 text-hover-primary mb-1">Abeer</a>
                                        ...
                                        <td>12/10/2001</td>
                                        <td>
                                            <div class="badge badge-light fw-bold">10:00 Am</div>
                                        </td>
                                        <td>12/11/2001</td>
                                        <td>
                                            <div class="badge badge-light fw-bold">11:00 Pm</div>
                                        </td>
                                        <td class="text-end">
                                            <div class="badge badge-light fw-bold">2 Hours</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <!--begin::User details-->
                                            <div class="d-flex flex-column">
                                                <a href="view-user.php" class="text-gray-800 text-hover-primary mb-1">Danish</a>
                                                <span>smith@kpmg.com</span>
                                            </div>
                                            <!--begin::User details-->
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <!--begin::User details-->
                                            <div class="d-flex flex-column">
                                                <a href="view-user.php" class="text-gray-800 text-hover-primary mb-1">Abdullah</a>
                                                <span>smith@kpmg.com</span>
                                            </div>
                                            <!--begin::User details-->
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <!--begin::User details-->
                                            <div class="d-flex flex-column">
                                                <a href="view-user.php" class="text-gray-800 text-hover-primary mb-1">Munawar</a>
                                                <span>smith@kpmg.com</span>
                                            </div>
                                            <!--begin::User details-->
                                        </td>
