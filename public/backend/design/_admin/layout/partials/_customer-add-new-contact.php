    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Customer Management</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-column gap-5">
                                ...
                                <!--begin::Contact group-->
                                <div class="d-flex flex-stack">
                                    <a href="apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Prospects</a>
                                    <div class="badge badge-light-primary">3</div>
                                </div>
                                <!--begin::Contact group-->
                                <!--begin::Contact group-->
                                <div class="d-flex flex-stack">
                                    <a href="customer-posted-order.php" class="fs-6 fw-bold text-primary text-hover-primary">Posted Custom Orders</a>
                                    <div class="badge badge-light-primary">1</div>
                                </div>
                                <!--begin::Contact group-->
                                <!--begin::Contact group-->
                                <div class="d-flex flex-stack">
                                    <a href="customer-first-subscriber.php" class="fs-6 fw-bold text-success text-hover-primary">First Time Subscribers</a>
                                    <div class="badge badge-light-primary">1</div>
                                </div>
                                <!--begin::Contact group-->
                                <!--begin::Contact group-->
                                <div class="d-flex flex-stack">
                                    <a href="customer-multiple-subscriber.php" class="fs-6 fw-bold text-warning text-hover-primary">Multiple Subscribers</a>
                                    <div class="badge badge-light-primary">1</div>
                                </div>
                                <!--begin::Contact group-->
                                <!--begin::Contact group-->
                                <div class="d-flex flex-stack">
                                    <a href="customer-brand-ambassador.php" class="fs-6 fw-bold text-info text-hover-primary">Brand Ambassadors</a>
                                    <div class="badge badge-light-primary">1</div>
                                </div>
                                <!--begin::Contact group-->
                                <!--begin::Contact group-->
                            ...
                            <div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_contacts_list_header" data-kt-scroll-wrappers="#kt_content, #kt_contacts_list_body" data-kt-scroll-stretch="#kt_contacts_list, #kt_contacts_main" data-kt-scroll-offset="5px">
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-ambassador-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Melody Macy</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-ambassador-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Max Smith</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-ambassador-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Sean Bean</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-first-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Brian Cox</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-first-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Mikaela Collins</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-first-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Francis Mitcham</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-first-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Olivia Wild</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-multiple-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Neil Owen</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-multiple-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Dan Wilson</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-multiple-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Emma Bold</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-multiple-subscriber-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Ana Crown</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-posted-order-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Robert Doe</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-posted-order-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">John Miller</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-posted-order-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Lucy Kunic</a>
                                ...
                                <div class="d-flex flex-stack py-4 members">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Details-->
                                        <div class="ms-4">
                                            <a href="customer-posted-order-detail.php" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 search_name">Ethan Wilder</a>
