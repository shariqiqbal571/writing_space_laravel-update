                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-semibold fs-6"><a href="new-order.php">New</a></span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-semibold fs-6"><a href="in-progress-order.php">In-Progress</a></span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-semibold fs-6"><a href="revisions.php">Revisions</a></span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-semibold fs-6"><a href="completed-order.php">Completed</a></span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-semibold fs-6"><a href="delivered.php">Delevired</a></span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-semibold fs-6"><a href="other.php">Others</a></span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                    ...
                    <div class="card card-flush mb-5">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <div class="text-gray-700 fw-semibold fs-6 me-2">Total Subscription Pages</div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <div class="text-gray-700 fw-semibold fs-6 me-2">Used Pages</div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                                <div class="d-flex align-items-senter">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <div class="text-gray-700 fw-semibold fs-6 me-2">Unused Pages</div>
                                <!--end::Section-->
                                <!--begin::Statistics-->
                                <div class="d-flex align-items-senter">
                                    <i class="ki-duotone ki-arrow-up-right fs-2 text-success me-2">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">Customer Journey</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                ...
                <div class="col-12 mb-5 mb-xl-0">
                    ...
                    <div class="card h-md-100">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-900">Orders Summary</span>
                            </h3>
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <!--begin::Daterangepicker(defined in src/js/layout/app.js)-->
                        ...
                        <div class="card-body pt-7 px-0">
                            ...
                            <ul class="nav nav-stretch nav-pills nav-pills-custom nav-pills-active-custom d-flex justify-content-start mb-8 px-5">
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_2">
                                        <span class="fs-7 fw-semibold">Sat</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_3">
                                        <span class="fs-7 fw-semibold">Sun</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger active" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_4">
                                        <span class="fs-7 fw-semibold">Mon</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_5">
                                        <span class="fs-7 fw-semibold">Tue</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_6">
                                        <span class="fs-7 fw-semibold">Wed</span>
                                        <span class="fs-6 fw-bold">6</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_7">
                                        <span class="fs-7 fw-semibold">Thu</span>
                                        <span class="fs-6 fw-bold">7</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_8">
                                        <span class="fs-7 fw-semibold">Fri</span>
                                        <span class="fs-6 fw-bold">8</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_9">
                                        <span class="fs-7 fw-semibold">Sat</span>
                                        <span class="fs-6 fw-bold">9</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    ...
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_11">
                                        <span class="fs-7 fw-semibold">Mon</span>
                                        <span class="fs-6 fw-bold">11</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_12">
                                        <span class="fs-7 fw-semibold">Tue</span>
                                        <span class="fs-6 fw-bold">12</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_13">
                                        <span class="fs-7 fw-semibold">Wed</span>
                                        <span class="fs-6 fw-bold">13</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_14">
                                        <span class="fs-7 fw-semibold">Thu</span>
                                        <span class="fs-6 fw-bold">14</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_15">
                                        <span class="fs-7 fw-semibold">Fri</span>
                                        <span class="fs-6 fw-bold">15</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_16">
                                        <span class="fs-7 fw-semibold">Sat</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_17">
                                        <span class="fs-7 fw-semibold">Sun</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_18">
                                        <span class="fs-7 fw-semibold">Mon</span>
                                        <span class="fs-6 fw-bold">18</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_19">
                                        <span class="fs-7 fw-semibold">Tue</span>
                                        <span class="fs-6 fw-bold">19</span>
                                    </a>
                                    <!--end::Date-->
                                </li>
                                <!--end::Nav item-->
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_20">
                                        <span class="fs-7 fw-semibold">Wed</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_21">
                                        <span class="fs-7 fw-semibold">Thu</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_22">
                                        <span class="fs-7 fw-semibold">Fri</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_23">
                                        <span class="fs-7 fw-semibold">Sat</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_24">
                                        <span class="fs-7 fw-semibold">Sun</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_25">
                                        <span class="fs-7 fw-semibold">Mon</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_26">
                                        <span class="fs-7 fw-semibold">Tue</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_27">
                                        <span class="fs-7 fw-semibold">Wed</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_28">
                                        <span class="fs-7 fw-semibold">Thu</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_29">
                                        <span class="fs-7 fw-semibold">Fri</span>
                                ...
                                <li class="nav-item p-0 ms-0">
                                    <!--begin::Date-->
                                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger" data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_30">
                                        <span class="fs-7 fw-semibold">Sat</span>
                            ...
                            <div class="tab-content mb-2 px-9">
                                ...
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_1">
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="flex-grow-1 me-5">
                                            <!--begin::Time-->
                                            <div class="text-gray-800 fw-semibold fs-2">Delivered
                                                <span class="text-gray-500 fw-semibold fs-7">(4)</span>
                                            </div>
                                            <!--end::Time-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="flex-grow-1 me-5">
                                            <!--begin::Time-->
                                            <div class="text-gray-800 fw-semibold fs-2">Revisions
                                                <span class="text-gray-500 fw-semibold fs-7">(4)</span>
                                            </div>
                                            <!--end::Time-->
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        <!--begin::Bullet-->
                                        <span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center min-h-50px mh-100 me-4 text-bg-info"></span>
                                        <!--end::Bullet-->
                                        <!--begin::Info-->
                                        <div class="flex-grow-1 me-5">
                                            <!--begin::Time-->
                                            <div class="text-gray-800 fw-semibold fs-2">In-Progress
                                                <span class="text-gray-500 fw-semibold fs-7">(4)</span>
                                            </div>
                                            <!--end::Time-->
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        <!--begin::Bullet-->
                                        <span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center min-h-50px mh-100 me-4 text-bg-danger"></span>
                                        <!--end::Bullet-->
                                        <!--begin::Info-->
                                        <div class="flex-grow-1 me-5">
                                            <!--begin::Time-->
                                            <div class="text-gray-800 fw-semibold fs-2">New
                                                <span class="text-gray-500 fw-semibold fs-7">(4)</span>
                                            </div>
                                            <!--end::Time-->
                                        </div>
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_16">
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_17">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_18">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_19">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_20">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_21">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_22">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_23">
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_24">
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_25">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_26">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_27">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_28">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_29">
                                    <!--begin::Wrapper-->
                                ...
                                <!--end::Tap pane-->
                                <!--begin::Tap pane-->
                                <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_30">
                                    <!--begin::Wrapper-->
