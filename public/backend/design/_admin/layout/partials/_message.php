                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--end::Menu toggle-->
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_654c7013afb70">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_654c7013afb70" data-allow-clear="true">
                                                        <option></option>
                                            ...
                                            <div class="fv-row mb-8">
                                                <!--begin::Label-->
                                                <label class="fs-6 fw-semibold">Order Id</label>
                                                <!--begin::Label-->
                                                <!--begin::Repeat Password-->
                                                <input type="text" placeholder="Order Id" name="order-id" class="form-control bg-transparent" />
                                                <!--end::Repeat Password-->
                                            </div>
                                            <!--end::Input group=-->
                                            <!--begin::Actions-->
                                    ...
                                    <div class="card">
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <!--end::Reload-->
                                                <!--begin::Delete-->
                                                <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-placement="top" title="Delete" id="deleteButton">
                                            ...
                                            <table class="table table-hover table-row-dashed fs-6 gy-5 my-0" id="kt_inbox_listing">
                                                <thead class="">
                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        <th class="min-w-100px ps-9">Checkbox</th>
                                                        <th class="min-w-100px">Actions</th>
                                                        <th class="min-w-100px">Order No</th>
                                                        <th class="min-w-250px">New Messages From Customer</th>
                                                        <th class="min-w-225px">New Messages From Writer</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="w-100px text-end fs-7 pe-9">
                                                            <span class="fw-semibold">23-02-2019 8:30 PM</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="badge badge-light-danger">Revision</div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
    ...
    document.getElementById('deleteButton').addEventListener('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Here, you can perform the actual delete action
