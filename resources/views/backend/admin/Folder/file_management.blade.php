                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">File Management - Files</h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="text-muted fw-bold">
                                                ...
                                                <a href="{{ url('/admin/folders/show') }}">File Management</a>
                                ...
                                <div class="card-header pt-8">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                                            ...
                                            <!--begin::Export-->
                                            <a href="{{ route('admin.folders.store') }}" type="button" class="btn btn-flex btn-light-primary me-3" id="kt_file_manager_new_folder">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="{{ route('admin.folders.view', ['id' => $f->id]) }}" class="text-gray-800 text-hover-primary">{{ $f->name }}</a>
                                                    </div>
                                                </td>
                                                        ...
                                                        <div class="ms-2">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="{{ route('admin.folders.download', ['id' => $f->id]) }}" class="menu-link px-3">Download File</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
