                                    ...
                                    <div class="card card-flush">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-title">
                                                <h2 class="mb-0">{{ $roles->name === 'is_admin' ? 'Admin' : 'Customer' }}</h2>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--end::Card header-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex flex-column text-gray-600">
                                                ...
                                                <div class="d-flex align-items-center py-2">
                                                    <span class="bullet bg-primary me-3"></span>... more
                                                </div>
                                            </div>
                                            <!--end::Permissions-->
                                        </div>
                                                    ...
                                                    <form id="kt_modal_update_role_form" class="form" method="post" action="{{ route('admin.update.role.permission') }}">
                                                        ...
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_role_header" data-kt-scroll-wrappers="#kt_modal_update_role_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-10">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control form-control-solid" placeholder="Enter a role name" name="name" value="{{ $roles->name === 'is_admin' ? 'Admin' : 'Customer' }}" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Permissions-->
                                        ...
                                        <div class="card-header pt-5">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <div class="d-flex align-items-center position-relative my-1" data-kt-view-roles-table-toolbar="base">
                                                    ...
                                                    <input type="text" data-kt-roles-table-filter="search" id="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Users" />
                                                </div>
                                                <!--end::Search-->
                                                <!--begin::Group actions-->
...
$(document).ready( function () {
    ...
    function handleTableSearch() {
        ...
        var searchText = $('[data-kt-roles-table-filter="search"]').val().toLowerCase();
    ...
    $('[data-kt-roles-table-filter="search"]').on('input', function () {
        handleTableSearch();
    });
</script>
