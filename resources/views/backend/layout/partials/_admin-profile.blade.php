                                            ...
                                            <div class="mb-7">
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                        ...
                                                        @else
                                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('backend/assets/media/avatars/300-6.jpg') }}')"></div>
                                                        @endif
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <form id="kt_modal_update_email_form"  class="form">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="" id="email_update" name="email" value="{{ old('email', $user->email) }}" />
                                    <p></p>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
