                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <!--begin::Desc-->
                                                    <span class="text-gray-500 fw-semibold fs-6"><a
                                                            href="in-progress-order.php">In-Progress</a></span>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Stats-->
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <!--begin::Desc-->
                                                    <span class="text-gray-500 fw-semibold fs-6"><a
                                                            href="revisions.php">Revisions</a></span>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Stats-->
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <!--begin::Desc-->
                                                    <span class="text-gray-500 fw-semibold fs-6"><a
                                                            href="completed-order.php">Completed</a></span>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Stats-->
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <!--begin::Desc-->
                                                    <span class="text-gray-500 fw-semibold fs-6"><a
                                                            href="delivered.php">Delevired</a></span>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Stats-->
                                            </div>
                        ...
                        <div class="card card-flush mb-5">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Section-->
                                    <div class="text-gray-700 fw-semibold fs-6 me-2">Total
                                        Subscription Pages</div>
                                    <!--end::Section-->
                                    <!--begin::Statistics-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Section-->
                                    <div class="text-gray-700 fw-semibold fs-6 me-2">Used Pages
                                    </div>
                                    <!--end::Section-->
                                    <!--begin::Statistics-->
                                    <div class="d-flex align-items-senter">
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Section-->
                                    <div class="text-gray-700 fw-semibold fs-6 me-2">Unused Pages
                                    </div>
                                    <!--end::Section-->
                                    <!--begin::Statistics-->
                                    <div class="d-flex align-items-senter">
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Customer
                                        Journey</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                    ...
                    <div class="col-12 mb-5 mb-xl-0">
                        ...
                        <div class="card h-md-100">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-900">Orders
                                        Summary</span>
                                </h3>
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                        ...
                                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" placeholder="Topic" name="topic" autocomplete="off"
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_new_orders">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    <tr>
                                        ...
                                        <td><span
                                                class="badge badge-light-danger fw-bold me-auto px-4 py-3">Disabled</span>
                                        </td>
                                        <td><a href="#"
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link d-flex justify-content-center px-3"
                                    ...
                                    <tr>
                                        ...
                                        <td>12/31/2023 12:45Pm</td>
                                        <td><span
                                                class="badge badge-light-success fw-bold me-auto px-4 py-3">Enabled</span>
                                        </td>
                                        <td><a href="#"
                                                class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm"
                                                data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
